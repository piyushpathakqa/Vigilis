...
| `TRE-46` | Treeship showcase: optional, decoupled provenance receipts over the loop | ✅ merged — `argus heal` seals a signed receipt by default (optional `@treeship/sdk`, zero hard dep); `docs/TREESHIP.md` |
